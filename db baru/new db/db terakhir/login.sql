...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2020 at 04:16 PM
...
('10', 'jancuk koe', 'PT. Metindo Erasakti', '', '', '', '', '', '', '', '', 30303, '2020-10-20', ''),
...
('8', 'jancuk koe', 'PT. Metindo Erasakti', '', '', '', '', '', '', '', '', 300, '2020-10-20', ''),
('9', 'jancuk koe', 'PT. Metindo Erasakti', '', '', '', '', '', '', '', '', 0, '2020-10-20', ''),
('asdas', 'jancuk koe', 'PT Metindo Erasakti', '', '', '', '', '', '', '', '', 300, '2020-10-20', 'asdwew'),
('wewaeaw', 'jancuk koe', 'PT Metindo Erasakti', '', '', '', '', '', '', '', '', 3002, '2020-10-20', '');
...
(1, 'PT Metindo Erasakti', 'Jancuk', '(0219) 5454685', 'wew1.jpg', '2020-09-19'),
...
CREATE TABLE `polibox` (
  `id_polibox` varchar(30) NOT NULL,
  `id_perusahaan` int(11) NOT NULL,
...
('asd', 1, '', 'polibox', 200, '', '', '2020-10-20', 'Belum DiKembalikan'),
('aweawdasdaw', 1, '', 'polibox', 120202, '', '', '2020-10-20', 'Belum DiKembalikan'),
('haha', 1, 'PT TRI SUKSES METAL', 'polibox', 500, 'Jakarta', 'Bekasi', '2020-09-27', 'Sudah DiKembalikan'),
('test', 1, 'PT TRI SUKSES METAL', 'polibox', 20, 'Jakarta', 'Bekasi', '2020-09-30', 'Belum DiKembalikan'),
('WKWK', 1, 'PT TRI SUKSES METAL', 'polibox', 10012, 'Jakarta', 'Bekasi', '2020-09-27', 'Belum DiKembalikan');
...
INSERT INTO `surat_jalan` (`id_surat`, `nosurat`, `id_perusahaan`, `pengirim`, `kd_part`, `part`, `jml`, `po`, `wo`, `alamat`, `alamat_pengirim`, `tgl`, `status`, `keterangan`, `nama_driver`, `plat`, `tgl_jalan`) VALUES
(1, 'AK01', 1, 'PT Trisukses Metal Presisi', '02', 'Baut', 500, '50', '123', 'Jalan Menteng', 'Bekasi', '2020-09-01', 'Sudah Diterima', '', 'wew', 'asdasdasd', '2020-10-11'),
(2, 'AK02', 1, 'PT Trisukses Metal Presisi', '03', 'sabun', 30, '20', '20', 'Jalan Menteng', 'Bekasi', '2020-09-27', 'Sudah Diterima', '', 'anto', 'asdasdas', '2020-10-11'),
(3, '03', 1, 'PT Trisukses Metal Presisi', '03', 'sabun', 500, '12', '2', 'Jakarta', 'Bekasi', '2020-09-29', 'Belum Diterima', '', '', '', '0000-00-00'),
(4, '04', 1, 'PT TRI SUKSES METAL', '03', 'sabun', 6000, '05', '6', 'Jakarta', 'Bekasi', '2020-09-29', 'Belum Diterima', '', '', '', '0000-00-00'),
(5, 'wew', 1, 'PT TRI SUKSES METAL', '01', 'Baut', 23, '32', '41', 'asdas', 'asd', '2020-10-10', 'Belum Diterima', 'test', '', '', '0000-00-00'),
(6, 'asdas', 1, 'PT TRI SUKSES METAL', '02', 'Baut', 50, 'asdas', 'asdas', 'asdas', 'asdas', '2020-10-11', 'Sudah Diterima', 'asdaswe', '', '', '0000-00-00'),
(7, 'sad', 1, '', '', 'Baut', 232, '223asdas', 'asdaswawwawaw', 'asdas', '', '2020-10-20', 'Belum Diterima', 'asdas', '', '', '0000-00-00'),
(8, 'jancuk koe', 1, '', '', 'Baut', 300, 'asdas', 'asdas', '', '', '2020-10-20', 'Belum Diterima', 'asdwew', '', '', '0000-00-00');
...
(8, '0', 'PT Metindo Erasakti', '', '', '', '', 30, '2020-10-20', ''),
(9, '0', 'PT Metindo Erasakti', '', '', '', '', 2, '2020-10-20', 'wew'),
(10, '0', 'PT Metindo Erasakti', '', '', '', '', 1, '2020-10-20', ''),
(11, 'WKWK', 'PT Metindo Erasakti', '', '', '', '', 302, '2020-10-20', ''),
(12, 'haha', 'PT Metindo Erasakti', '', '', '', '', 22, '2020-10-20', '');
