    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container bg-white pb-2">
                ...
                <h1 class="text-center mb-4 pt-4">Surat Peminjaman Polibox</h1>
                <?php $i = 1; ?>
                                <?php foreach ($polibox as $s) : ?>
                <a href="<?= base_url() ?>admin/printpolibox/<?= $s['id_polibox']; ?>/<?= $s['id_perusahaan']; ?>"><button class="btn btn-dark mb-4">Print Surat Peminjaman</button></a>
