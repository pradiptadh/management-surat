    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container bg-white pb-2">
                ...
                <a href="<?= base_url() ?>customer/printberita/<?= $s['id_berita']; ?>"><button class="btn btn-dark mb-4">Print Surat BAST</button></a>
                ...
                <table class="table table table-sm mb-1">
                    <tr>
                        ...
                        <td style="vertical-align:middle;" align="center"><b><?= $s['perusahaan']; ?></b> 
                        <?php $i = 1; ?>
                        ...
                        <table class="table">
                            ...
                            <tr>
                            <th >Kepada : <br> PT TRISUKSES METAL PRESISI</br> </th>

                            <th>Alamat Penerima : Bekasi</th>
