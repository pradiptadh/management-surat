                            ...
                            <tbody>
                                ...
                                <?php foreach ($berita as $j) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url() ?>customer/lihatsuratberita/<?= $j['id_berita']; ?>/<?= str_replace(' ','_', $j['perusahaan']);?>/<?= $j['part']; ?>" class="badge badge-warning" style="background-color: #008CBA;">Lihat</a>
